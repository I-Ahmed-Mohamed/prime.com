...
class AIAssistant {
    ...
    setupEventListeners() {
        ...
        // Language change
        document.getElementById('ai-language-select').addEventListener('change', (e) => {
    ...
    getLocalResponses(message, lang) {
        ...
        const ahmedInfo = {
            skills: ['HTML5, CSS3, JavaScript', 'React, Vue.js', 'Node.js, PHP, Laravel', 'Python, Django', 'MySQL, MongoDB', 'Git & GitHub', 'React Native, Flutter', 'REST APIs', 'UI/UX Design'],
            services: ['تطوير مواقع ويب احترافية', 'تطوير تطبيقات الموبايل', 'حلول برمجية مخصصة', 'استشارات تقنية', 'تصميم واجهات المستخدم', 'دعم وصيانة فنية']
        };
        
        // Multilingual responses
        const responses = {
            ar: {
                greeting: 'مرحباً! 👋 أنا المساعد الذكي لأحمد محمد. كيف يمكنني مساعدتك؟',
                ...
                default: 'يمكنني مساعدتك في معرفة:\n\n• مهارات وخبرات أحمد\n• الخدمات المقدمة\n• المشاريع السابقة\n• طرق التواصل\n\nما الذي تريد معرفته؟'
            },
            en: {
                greeting: 'Hello! 👋 I\'m Ahmed Mohamed\'s AI assistant. How can I help you?',
        ...
        if (lowerMessage.match(/من هو|who is|من أحمد|about|عن أحمد|tell me about|أخبرني/i)) {
    ...
    addMessage(text, type) {
        ...
        // Add to history
        this.conversationHistory.push({ text, type, time: new Date().toISOString() });
    }
    ...
    speak(text) {
        ...
        utterance.rate = parseFloat(document.getElementById('ai-voice-speed').value);
    ...
    getLanguageCode() {
        ...
        const lang = this.currentLanguage === 'auto' ? this.detectLanguage() : this.currentLanguage;
    ...
    showSuggestions(input) {
        ...
        if (filtered.length > 0) {
            const suggestionsHTML = filtered.map(s => 
    ...
    setupLanguageDetection() {
        ...
        setInterval(() => {
            if (this.currentLanguage === 'auto') {
                ...
                document.getElementById('ai-lang-display').textContent = detected.toUpperCase();
            } else {
                document.getElementById('ai-lang-display').textContent = this.currentLanguage.toUpperCase();
            }
        }, 1000);
    }
