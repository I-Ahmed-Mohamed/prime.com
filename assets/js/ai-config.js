...
const AI_CONFIG = {
  ...
  localResponses: {
    ar: {
      ...
      portfolio:
        "يمكنك الاطلاع على أعمالي في قسم المشاريع. هل تريد أن أوجهك إليه؟",
      skills:
        "أمتلك خبرة واسعة في تطوير الويب، البرمجة، وتطوير التطبيقات. ما الذي يهمك بالتحديد؟",
      contact:
        "يمكنك التواصل معي عبر نموذج الاتصال أو البريد الإلكتروني. هل تريد المساعدة؟",
    ...
    en: {
      ...
      portfolio:
        "You can check out my work in the Projects section. Would you like me to guide you there?",
      skills:
        "I have extensive experience in web development, programming, and app development. What specifically interests you?",
      contact:
        "You can reach me through the contact form or email. Need help with that?",
